"""Render checked physical designs into canonical block-state maps."""
...
from Formats.Litematic.Codec import LoadTemplate, NeutralDynamicState
...
TRACE_PALETTE = (
    ...
    "minecraft:light_blue_concrete", "minecraft:red_concrete", "minecraft:orange_concrete",
