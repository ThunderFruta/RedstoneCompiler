...
from PhysicalDesign.Contracts.PhysicalInterface import PhysicalGlobalPlanDescriptorProgressState, PhysicalGlobalPlanResumeCursor, PhysicalGlobalPlanContinuationState, PhysicalSignalRouteDomainDescriptorProgressState
...
def BuildClosedComponentRuntimeIncompleteFailure(
    Schedule: ClusterInterfaceStageSchedule,
    ComponentSolve: Any,
    *,
