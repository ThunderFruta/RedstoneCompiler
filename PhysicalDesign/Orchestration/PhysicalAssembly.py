...
from PhysicalDesign.Placement.Engine.Repair import BuildTransactionalClusterEndpointRepair
...
def ReserveAuthoritativeGlobalChannels(Context, Assembly: Any) -> tuple[Any, RoutedDesign | None]:
    ...
    while True:
        ...
        try:
            ...
            GlobalChannelDesign = Context.Services.RoutePcbDesign(GlobalPlanningPlacement, Policy=GlobalPlanningPolicy, Deadline=GlobalPlanningDeadline, Resources=Context.InterfaceResources, Technology=Context.Technology)
