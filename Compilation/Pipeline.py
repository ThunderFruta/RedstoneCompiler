...
from PhysicalDesign.Orchestration.Candidates import ApplyRoutingRuntimeBudget
...
from Validation.Physical import BuildFabricCanaryVectors, BuildPhysicalFixture, PhysicalValidationProgress, PhysicalValidationResult, WritePhysicalFixture
from Formats.Litematic import Codec
from PhysicalDesign.Rendering import Renderer
from PhysicalDesign.Rendering.Renderer import BlockCompositionMetrics

# Publication still uses the Litematic codec; retain this local name for callers
# and test seams while rendering and file encoding remain separate modules.
SchemWriter = Codec
