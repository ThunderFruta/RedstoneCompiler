...
| `RuntimeBudgetExceeded` | The one absolute compile deadline expired | Stop further candidates, preserve partial diagnostics, and report the stage; do not restart or silently enlarge the deadline |
