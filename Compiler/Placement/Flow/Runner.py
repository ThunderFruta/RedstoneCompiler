...
from Compiler.Routing.Pcb import RoutePcbDesign
from Compiler.Routing.Contracts.Results import RoutedDesign
from Compiler.Routing.LocalFirst import BuildLocalFirstSnapshot, MeasurePlacementRoutingFeedback
from Compiler.Routing.Actions import ValidatePlacedCellElectricalIsolation
from Compiler.Routing.Actions.Geometry import BuildRoutingResources
from Compiler.Routing.Policy import DefaultPhysicalDesignPolicy, PhysicalDesignPolicy
from Compiler.Routing.Policy import ExecutionStrategyForRequest, PolicyForRoutingStrategy, RoutingStrategy
from Compiler.Routing.Technology import DefaultRedstoneRoutingTechnology, RedstoneRoutingTechnology
...
def PlaceAndRoutePcb(Netlist: Any, ProgressCallback: Callable[[PcbProgress], None] | None=None, Policy: PhysicalDesignPolicy=DefaultPhysicalDesignPolicy, Technology: RedstoneRoutingTechnology=DefaultRedstoneRoutingTechnology, Strategy: RoutingStrategy | str | None=None, RoutedValidationCallback: Callable[[RoutedDesign], None] | None=None, RoutingDeadlineSeconds: float | None=None) -> PcbResult:
    ...
    return _PlaceAndRoutePcbWithPolicy(Netlist, ProgressCallback=ProgressCallback, Policy=ActivePolicy, Technology=Technology, RequestedStrategy=RequestedStrategy, UsedStrategy=UsedStrategy, RoutedValidationCallback=RoutedValidationCallback)


def _PlaceAndRoutePcbWithPolicy(Netlist: Any, ProgressCallback: Callable[[PcbProgress], None] | None, Policy: PhysicalDesignPolicy, Technology: RedstoneRoutingTechnology, RequestedStrategy: RoutingStrategy, UsedStrategy: RoutingStrategy, RoutedValidationCallback: Callable[[RoutedDesign], None] | None=None, Services: PlacementFlowServices | None=None) -> PcbResult:
