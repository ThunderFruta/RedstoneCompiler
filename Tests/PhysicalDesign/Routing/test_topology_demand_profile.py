...
class TopologyDemandProfileTests(unittest.TestCase):
    ...
    def testPhysicalProofConsumesRetainedPlacementBeforeGeneration(
        ...
        with patch(
            "PhysicalDesign.Flow.Candidates."
            "BuildComponentAccessFeedbackPlacementScore",
