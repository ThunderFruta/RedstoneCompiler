...
from Compiler.Routing.Contracts import (
    Component,
    Core,
    PhysicalInterface,
    Placement,
...
ExpectedRoutingContractSchemaHash = (
    "28d36ca12f5f51aadc6153a2255428d38410390b277866535aaead2b5410be95"
)
ContractFamilies = {
    "Component": Component,
    "Core": Core,
...
def test_routing_contract_schema_matches_pre_split_baseline() -> None:
    """Field order/defaults and callable signatures remain unchanged."""
